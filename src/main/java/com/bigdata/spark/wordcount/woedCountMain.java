...
woedCountMain {
    public static void main(String[] args) {
        ...
        // 是文件里的一行
        JavaRDD<String> file = context.textFile("H:\\java\\Spark\\北风网Spark 2.0从入门到精通-278讲\\000.课程代码+软件包\\第29讲-Spark核心编程：使用Java、Scala和spark-shell开发wordcount程序\\文档\\spark.txt");
