    ...
    public static void main(String[] args) throws Exception {
        ...
        clickLog.mapToPair(line -> new Tuple2<String, Integer>(line.split(" ")[1] + "_" + line.split(" ")[2],1))
                ...
                .foreachRDD(rdd -> {
                    ...
                    Dataset<Row> df = hiveContext.createDataFrame(ca_pr_rowRDD, structType);
                    hiveContext.registerDataFrameAsTable(df,"ca_pr_table");
                    hiveContext.sql("select category,product,count_num from (" +
